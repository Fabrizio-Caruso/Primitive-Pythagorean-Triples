...
c64_short:
	cl65$(EXEEXT) -t c64 -DUSE_SHORT -DTARGET=1000 -DDISPLAY_START=981 -Oisr -Cl PPT.c -o PPT_short.prg
	rm PPT.o
...
pc_short:
	gcc -DUSE_SHORT -DTARGET=1000 -DDISPLAY_START=981 PPT.c -o PPT_short$(COMPILEDEXT)
